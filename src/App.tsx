...
export default function App() {
    ...
    if (phase === "pin") {
        ...
        return (
            <div className={`w-full h-screen flex items-center justify-center ${bgClass}`}>
                <div className={`w-80 p-8 rounded-3xl shadow-xl border border-white/50 text-center ${cardClass}`}>
                    ...
                    <motion.div
                        className={`w-full py-3 mb-4 text-3xl tracking-widest rounded-2xl bg-white/80 border ${
                            error ? "border-red-400 text-red-500" : "border-gray-300 text-gray-700"
                        }`}
